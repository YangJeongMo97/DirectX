...
HRESULT InitVertex() {
    CUSTOMVERTEX vertices[] = { {-0.8f, 0.5f, 0.0f, 0.0f, 0.0f, 0xffffffff},      //0
                                {0.2f, 0.5f, 0.0f, 1.0f, 0.0f, 0xffffffff},       //1
                                {0.2f, -0.5f, 0.0f, 1.0f, 1.0f, 0xffffffff},      //2
                                {-0.8f, -0.5f, 0.0f, 0.0f, 1.0f, 0xffffffff},     //3
                                {-0.3f, 0.7f, 0.5f, 1.0f, 0.0f, 0xffffffff},       //4
                                {0.7f, 0.7f, 0.5f, 0.0f, 0.0f, 0xffffffff},        //5
                                {0.7f, -0.3f, 0.5f, 0.0f, 1.0f, 0xffffffff},       //6
                                {-0.3f, -0.3f, 0.5f, 1.0f, 1.0f, 0xffffffff} };    //7

    D3DXCreateTextureFromFile(g_pd3dDevice, "Text.bmp", &g_pTexture1);

    g_pd3dDevice->CreateVertexBuffer(8 * sizeof(CUSTOMVERTEX), 0, D3DFVF_XYZ, D3DPOOL_DEFAULT, &g_pVB, NULL);
